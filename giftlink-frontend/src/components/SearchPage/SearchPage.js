                ...
                <div className="col-md-8">
                    <div className="filter-section mb-3 p-3 border rounded">
                        ...
                        <div className="d-flex flex-column">
                            ...
                            <label htmlFor="categorySelect" className="mt-2">Category</label>
                            ...
                            <label htmlFor="conditionSelect" className="mt-2">Condition</label>
                            ...
                            <label htmlFor="ageRange" className="mt-2">Less than {ageRange} years</label>
                            <input
                                type="range"
